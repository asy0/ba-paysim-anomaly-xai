...
- Datei `data/paysim.csv`: die große CSV liegt aus **GitHub-Dateigrößengründen nicht im Repository** — bitte von [PaySim1 auf Kaggle](https://www.kaggle.com/datasets/ealaxi/paysim1) laden und als `data/paysim.csv` ablegen (ohne diese Datei schlagen Datenladen und Training fehl)
